...
ADR-2607011000: the governor gates every action; direct field/irrigation-
equipment operation, finalizing a pesticide-application decision, and any
non-`:propose` effect are permanently blocked; `:high`/`:safety-critical`
actions (crop-health/pest concerns, high-cost supply orders) require human
sign-off.
